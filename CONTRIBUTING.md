Contributing to BITSTATS Core
============================

The BITSTATS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitstats-project/bitstats/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BITSTATS Core project, and is not to be
confused with overall BITSTATS Network Protocol consensus changes.

Whether a pull request is merged into BITSTATS Core rests with the project merge
...
Patches that change BITSTATS consensus rules are considerably more involved than
...
Where a patchset proposes to change the BITSTATS consensus, it must have been
...
The project leader is the release manager for each BITSTATS Core release.
