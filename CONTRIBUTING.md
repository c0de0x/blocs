Contributing to BLOCS Core
============================

The BLOCS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/blocs-project/blocs/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BLOCS Core project, and is not to be
confused with overall BLOCS Network Protocol consensus changes.

Whether a pull request is merged into BLOCS Core rests with the project merge
...
Patches that change BLOCS consensus rules are considerably more involved than
...
Where a patchset proposes to change the BLOCS consensus, it must have been
...
The project leader is the release manager for each BLOCS Core release.
