...
This document provides guidelines for internationalization of the BLOCS Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to BLOCS network</numerusform>
            <numerusform>%n active connections to BLOCS network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blocs_en.ts` remains unchanged.
