...
#ifndef BLOCS_ZBLOCSTRACKER_H
#define BLOCS_ZBLOCSTRACKER_H
...
public:
    CzBLOCSTracker(std::string strWalletFile);
    ~CzBLOCSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBLOCSWallet* zBLOCSWallet = NULL);
