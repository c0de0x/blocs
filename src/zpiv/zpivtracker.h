...
#ifndef BITSTATS_ZBTSTTRACKER_H
#define BITSTATS_ZBTSTTRACKER_H
...
public:
    CzBTSTTracker(std::string strWalletFile);
    ~CzBTSTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBTSTWallet* zBTSTWallet = NULL);
