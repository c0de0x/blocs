...
#ifndef BITSTATS_ZBTSTWALLET_H
#define BITSTATS_ZBTSTWALLET_H
...
public:
    CzBTSTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBTST(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBTST(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
