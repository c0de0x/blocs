...
#ifndef BLOCS_ZBLOCSWALLET_H
#define BLOCS_ZBLOCSWALLET_H
...
public:
    CzBLOCSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBLOCS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBLOCS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
