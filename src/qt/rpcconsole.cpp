                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBTSTPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzBTSTPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzBTSTPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBTSTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BITSTATS RPC console.") + "<br>" +
