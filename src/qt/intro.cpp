...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BITSTATS Core"),
     ...
     * override -datadir in the bitstats.conf file in the default data directory
     * (to be consistent with bitstatsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
