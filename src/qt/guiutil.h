...
/** Utility functions used by the BLOCS Qt UI.
 */
namespace GUIUtil
{
...
// Render BLOCS addresses in monospace font
...
// Parse "blocs:" URI into recipient object, return true on successful parsing
