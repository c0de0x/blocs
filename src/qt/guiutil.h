...
/** Utility functions used by the BITSTATS Qt UI.
 */
namespace GUIUtil
{
...
// Render BITSTATS addresses in monospace font
...
// Parse "bitstats:" URI into recipient object, return true on successful parsing
