...
RESOURCES += src/qt/blocs.qrc src/qt/blocs_locale.qrc

TRANSLATIONS += src/qt/locale/blocs_bg.ts \
                src/qt/locale/blocs_de.ts \
                src/qt/locale/blocs_en.ts \
                src/qt/locale/blocs_es.ts \
                src/qt/locale/blocs_fi.ts \
                src/qt/locale/blocs_fr.ts \
                src/qt/locale/blocs_it.ts \
                src/qt/locale/blocs_ja.ts \
                src/qt/locale/blocs_pl.ts \
                src/qt/locale/blocs_pt.ts \
                src/qt/locale/blocs_ru.ts \
                src/qt/locale/blocs_sk.ts \
                src/qt/locale/blocs_sv.ts \
                src/qt/locale/blocs_vi.ts \
                src/qt/locale/blocs_zh_CN.ts \
                src/qt/locale/blocs_zh_TW.ts
